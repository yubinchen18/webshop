...
class SearchesController extends AppController
{
    ...
    public function showResults()
    {
        ...
        if ($searchTerm) {
            ...
            $addresses = $schoolsTable->Projects->Groups->Persons->Addresses->find('search', compact('searchTerm'))->toArray();

            $orders = $schoolsTable->Projects->Groups->Persons->Addresses->Users->Orders->find('search', compact('searchTerm'))->toArray();
        } else {
