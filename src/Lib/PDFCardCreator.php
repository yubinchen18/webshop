...
class PDFCardCreator
{
    ...
    {        
        ...
        $this->pdf->MultiCell(	
                ...
                $person->firstname ) . ( $person->prefix != "" ? " " . iconv( "UTF-8", "ISO-8859-1//TRANSLIT", $person->prefix ) : "" ) . " " . iconv( "UTF-8", "ISO-8859-1//TRANSLIT", $person->lastname ) . PHP_EOL .
    ...
    private function addAnoniemStudentCard($group)
    {
        ...
        $this->pdf->MultiCell(	
                ...
                5, 
                "Anoniem" . PHP_EOL . 
                "KLAS " . iconv( "UTF-8", "ISO-8859-1//TRANSLIT", $group->name ) . " " . iconv( "UTF-8", "ISO-8859-1//TRANSLIT", $group->project->school->name ) . PHP_EOL
        );
