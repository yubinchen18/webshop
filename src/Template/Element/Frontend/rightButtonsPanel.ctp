<div class='index-right col-sm-1 hidden-xs photos-view-buttons-panel'>
    <div class="fixed" data-product-group= '<?= $this->request->params['pass'][0]; ?>' data-photo-id="<?= $this->request->params['pass'][1]; ?>">
        <div class='photos-view-buttons-box photos-view-buttons-box1' id="photos-view-buttons-box1">
        ...
        <div class='photos-view-buttons-box photos-view-buttons-box2' id="photos-view-buttons-box2">
