...
jQuery.fn.slug = function(options) {
	var settings = {
		...
		hide: true,    // Boolean - By default the slug input field is hidden, set to false to show the input field and hide the span.
                prefix: '', //standard prefix of the slug
                direct: false //directly execute
	};
	...
	var transliterate = function(str) {
		...
		var slug = transliterate(jQuery.trim($this.val()))
			...
			.replace(/^\-/, '')
			;
		$('input.' + settings.slug).val(settings.prefix+slug);
		$('span.' + settings.slug).text(settings.prefix+slug);
	};
