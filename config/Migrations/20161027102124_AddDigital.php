...
class AddDigital extends AbstractMigration
{
    ...
    public function change()
    {
        $this->query(
            ...
            (UUID(), 'DIGITAAL ALLES', 'DPack', 'digital_pack', '<div><strong>Digital alles bestaat uit:</strong></div>\r\n<div>Alle foto\'s, behalve de groepfoto\'s voor een standaard prijs.</div>', 35.00, 21.00, NULL, 1, '2016-09-28 15:04:22', '2016-09-28 15:04:22', NULL, 'LoosePrintLayout1', 'digital');"
        );
    }
}
